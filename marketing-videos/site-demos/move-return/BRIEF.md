...
- assets/return-1280x800.mp4 — the app, recorded frame by frame from the capture rig.
- assets/return-sheet-1280x800.webm — the restore sheet alone, recorded with alpha.
